                ...
                <tbody>
                    <tr style="background-color: #ffffff;">
                        <td style="text-align: left; padding: 8px 15px; font-size: 0.8rem; border-bottom: 1px solid #e9ecef;">
                            <span style="color: #495057;"><img src="./images/fabrica.png" alt="Fabrica" style="width: 25px; height: 25px;"></span>
                            <span style="margin-left: 8px; color: #212529;">' . htmlspecialchars($row['marca']) . '</span>
                        </td>
                        <td style="text-align: left; padding: 8px 15px; font-size: 0.8rem; border-bottom: 1px solid #e9ecef;">
                            <span style="color: #495057;"><img src="./images/coche.png" alt="Modelo" style="width: 25px; height: 25px;"></span>
                            <span style="margin-left: 8px; color: #212529;">' . htmlspecialchars($row['modelo']) . '</span>
                        </td>
                    </tr>
                    <tr style="background-color: #f8f9fa;">
                        <td style="text-align: left; padding: 8px 15px; font-size: 0.8rem;">
                            <span style="color: #495057;"><img src="./images/calendario.png" alt="Año" style="width: 25px; height: 25px;"></span>
                            <span style="margin-left: 8px; color: #212529;">' . htmlspecialchars($row['ano']) . '</span>
                        </td>
                        <td style="text-align: left; padding: 8px 15px; font-size: 0.8rem;">
                            <span style="color: #495057;"><i class="fa-solid fa-boxes-stacked fa-2xl"></i></span>
                            <span style="margin-left: 8px; color: #212529;">' . htmlspecialchars($row['existencia']) . '</span>
                        </td>
                    </tr>
                    <tr>
                      <td style="text-align: left; padding: 8px 15px; font-size: 0.8rem;">
                          <span style="color: #495057;"><img src="./images/moneda.png" alt="Precio" style="width: 25px; height: 25px;"></span>
                          <span style="margin-left: 8px; font-weight: bold; color: #212529;">' . htmlspecialchars($row['precio']) . '</span>
                      </td>
                    </tr>
                </tbody>                    
            </table>
