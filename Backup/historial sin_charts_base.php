...
<body>
    <div class="container mt-4">
        ...
        if (isset($_GET['search']) && !empty($_GET['search'])) {
            $tagid = $conn->real_escape_string($_GET['search']);
            $baseQuery_peso = "SELECT * FROM h_peso WHERE tagid = '$tagid'";
        } else {
        ...
        <div class="table-section">
            ...
            if (isset($_GET['search']) && !empty($_GET['search'])) {
                $tagid = $conn->real_escape_string($_GET['search']);
                $baseQuery_leche = "SELECT * FROM h_leche WHERE tagid = '$tagid'";
            } else {
        ...
        if (isset($_GET['search']) && !empty($_GET['search'])) {
            $tagid = $conn->real_escape_string($_GET['search']);
            $baseQuery_racion = "SELECT * FROM h_racion WHERE tagid = '$tagid'";
        } else {
